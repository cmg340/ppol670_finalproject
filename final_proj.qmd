...
We continued exploring our data by creating a number of graphs of the relationships between variables of interest and obesity. To make this process easier, we wrote custom functions to make multiple plots.
...
interactivemapdata <- combined_census %>% select(name, state, census_tract_x, obesity_num, median_family_income, csmoking, teethlost, maptext) 
