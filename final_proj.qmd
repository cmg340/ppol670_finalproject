...
#NO LONGER NEEDED BELOW THIS CODEBLOCK
#census <- st_read(dsn = "cb_2020_us_county_20m.shp")
#census <- census %>%
 # st_set_crs(value = 4326) 

# clean and preprocess dataset - remove missing values, outliers or irrelevant variables that may affect the analysis 
```
...
obesity_tracts <-  ggplot()+
  geom_sf(data = combined_census, 
          aes(fill = OBESITY))+
  labs(title = "Obesity by census tract in the US")+
  theme_void()
